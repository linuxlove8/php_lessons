...
echo "<a href='functions_index.php?favmovie=$myfavmovie'>";
echo "Click here to see information about my favotite movie";
echo "</a>";
echo "<br>"; 

echo "<a href='functions_index.php?movienum=5'>";
echo "Click here to see my top 5 movies";
echo "</a>";
echo "<br>";

echo "<a href='functions_index.php?movienum=10'>";
echo "Click here to see my 10 movies";
echo "</a>";
